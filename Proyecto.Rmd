...
Con base en el análisis realizado se llega a algunas conclusiones, que sólo son válidas en el contexto de la muestra seleccionada:

- Los propietarios de las empresas con mayores niveles de educación formal son los más innovadores y también son quienes más contratan personal profesional. A su vez, los propietarios de las empresas que cuentan con bosques o praderas artificiales también son los mas innovadores.

- Relacionado al tamaño de las explotaciones observamos que existe una alta correlación con la dimensión del rodeo (cantidad de unidades ganaderas) a pesar de haber también casos con altos niveles de carga (unidades ganaderas por hectárea) y al contrario en el cual en grandes extensiones tienen muy pocos ovinos o vacunos.
	
Con respecto al personal contratado por los productores, vemos como el personal profesional es mayormente contratado a comparación del personal zafral.
Centrándonos en éste último, podemos concluir que sin importar el propietario que lo contrate, su remuneración con respecto a los jornales que realice no varía mucho.	

En relación con las cuestiones demográficas, observamos que los propietarios del territorio uruguayo mayormente son hombres entre los 40 y 60 años.

\textcolor{violet}{Hicieron un buen trabajo y me gustó su presentación. Comentarios del documento: No cumple todos los requísitos, les faltó usar referencias cruzadas, lo cual dificulta enganchar lectura y gráficas. EL texto y figuras están desordenados y no agregan bibliografía. Deben diferenciar en el título de los gráficos cuando tienen un gráfico de barras apiladas y uno apilado al $100\%$.
La escritura del texto es buena  aunque no cumpla tener secciones para cada parte.
Alguna mejora en los gráficos (en vez de leyendas ponerlo en los ejes)
Mencionan que crean un índice de innovación en la presentación como una suma de variables (me pareció muy bien), les faltó mencionarlo en el documento.
Son precisos al analizar relaciones lineales y no inferir relaciones causales.
No incluyen una sección con la descripción de la aplicación shiny.
La aplicación está bien armada, incluye descripción, distintas ventas con análisis interactivos. Gran mejora y avance respecto a la anterior.}
\textcolor{violet}{PUNTOS: 20/25}
