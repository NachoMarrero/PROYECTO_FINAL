...
Para realizar la exploración, nos planteamos algunas preguntas para orientar el análisis. En primer lugar, decidimos investigar la condición jurídica de los propietarios encuestados. Observamos como en su mayoría son personas físicas.
 
```{r, fig.cap= "Gráfico de barras sobre la condicion Juridica de los encuestados"}
...
```{r, fig.cap="Gráfico de barras apiladas que refiere a la realización de innovaciones según el nivel educativo del propietario."} 
...
datos %>% 
  ...
  labs(x="Estrato de tamaño",y="Tenencia de la tierra",fill="Tenencia de la tierra")+
  theme_bw()
```
