...
datos %>% 
  ...
  scale_x_discrete(name="Condición jurídica",labels = c(
                                                       ...
                                                       '4' = 'Otra'))
```
Siguiendo con el analisis de las personas encuestadas, avergiuamos las edades y el sexo de las personas fisicas propietarias. Tambien analizamos el nivel de educacion de los encuestmaos y nos ecnontramos con una muy distribuida poblacion, subvidiviendo en 3 grupos basico, basico superior y terciario, llegamos a que la diferencia en la cantidad de personas en los 3 grupos es muy pequeña, lo que nos lleva a pensar que no hay una relacion entre la tenencia de tierra y el nivel de educacion.
