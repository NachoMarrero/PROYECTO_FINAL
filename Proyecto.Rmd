...
##Conclusiones Finales.
	...
	Podemos concluir en base al analysis, que las personas  dueñas de los campos con mayores niveles de estudios son quienes mas innvovan, y en relacion a eso tambien son quines mas contratan personal profesional, esto nos demeustra que dichas personas puede que le dediquen, o inviertan mas tiempo y dinero en su produccion, relacionado al territorio observamos como ocurre lo esperado que a mayor tamaño de territorio mas cantidad de Unidades ganaderas a pesar de haber tambien casos en los cuales el campo esta super explotado y al contrario en el cual en grandes extensiones tienen muy pocos ovinos o bovinos lo cual podria deberse a un mal terreno para la ganaderia o que simplemente es campo desaptovechado. Tambien observamos que los propietarios del territorio Uruguayo mayormente son hombres entre los 40 y 60 años.
