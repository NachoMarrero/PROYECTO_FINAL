...
ai_nueva = rowSums(ai_nueva[ , c("aiv_1","aiv_2","aiv_3","aiv_4","aiv_5","aiv_6","aiv_7","aiv_8",
                                   "aio_1","aio_2","aio_3","aio_4","aio_5","aio_6","aio_7","aio_8")])

datos<-cbind(datos,aiv_nueva,aio_nueva)
